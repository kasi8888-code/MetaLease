            ...
            {displayListings.map((listing, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]">
                ...
                <div className="aspect-square bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className={`absolute inset-0 flex items-center justify-center bg-gradient-to-br from-blue-100 to-purple-100 ${listing.image ? 'hidden' : ''}`}>
                    <div className="text-center">
                      ...
                      <span className="text-gray-500 text-xs font-medium">NFT Image</span>
                    </div>
                  </div>
                </div>
